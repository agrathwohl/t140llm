...
export class T140RtpMultiplexer extends EventEmitter {
  ...
  addStream(
    ...
    const csrcId = this.multiplexConfig.useCsrcForStreamId ? this.nextCsrcId++ : undefined;
    ...
    const streamInfo: StreamInfo = {
      ...
      options: {
        ...
        handleMetadata: processorOptions.handleMetadata !== false && config.handleMetadata !== false,
      },
      buffer: '',
      charQueue: [],
    };
