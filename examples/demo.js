...
function demoSRTP() {
  ...
  const { masterKey, masterSalt } = createSrtpKeysFromPassphrase('SecureT140Demo');
  ...
  // Process the stream using library
  const transport = processAIStreamToSrtp(stream, '127.0.0.1', srtpConfig, 5006);
...
async function comparePerformance() {
  ...
  console.log('1. Proper RTP/SRTP encapsulation for standard-compliant transmission');
